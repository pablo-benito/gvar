...
/*
	...
	(c,
	 (unsigned)((double)Ysize/(double)VIS_LINES_PER_LINE[i][c]*Opt.yscale(f,i,c)),
	 (unsigned)((double)Xsize/(double)VIS_PIX_PER_PIX[i][c]*Opt.xscale(f,i,c)));
*/
...
/*
	...
	(c,
	 (int)((double)Ystart/(double)VIS_LINES_PER_LINE[i][c]*Opt.yscale(f,i,c)),
	 (int)((double)Xstart/(double)VIS_PIX_PER_PIX[i][c]*Opt.xscale(f,i,c)));
*/
